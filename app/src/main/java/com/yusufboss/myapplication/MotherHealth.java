...
public class MotherHealth extends ActionBarActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        setContentView(R.layout.activity_mother_health);
                    ...
                    public void onItemClick(AdapterView<?> parent, View view, int position, long id, IDrawerItem drawerItem) {
                        if (drawerItem instanceof Nameable) {
                            ...
                            if (drawerItem.getIdentifier() == 0) {
                                ...
                                startActivity(new Intent(MotherHealth.this, MainActivity.class));
                                //Toast.makeText(getBaseContext(),"On Drawer Created",Toast.LENGTH_LONG).show();

                            } else if (drawerItem.getIdentifier() == 1) {
                                //fragment = new Calculator();
                                startActivity(new Intent(MotherHealth.this,HealthCalculator.class));


                            }/* else if (drawerItem.getIdentifier() == 2) {

                                startActivity(new Intent(MainActivity.this, MotherHealth.class));
                            }*/
                            else if (drawerItem.getIdentifier() == 3) {

                                startActivity(new Intent(MotherHealth.this, ChildHealth.class));
                            } else if (drawerItem.getIdentifier() == 4) {
                                startActivity(new Intent(MotherHealth.this, Hospital.class));
                            } else if (drawerItem.getIdentifier() == 5) {
                                startActivity(new Intent(MotherHealth.this, EmergencyContact.class));
                            }
                            else if (drawerItem.getIdentifier() == 6) {
                                startActivity(new Intent(MotherHealth.this, Vaccination.class));
                            }
                            if (fragment != null) {
...
//        getSupportActionBar().setHomeButtonEnabled(false);
    ...
    public boolean onCreateOptionsMenu(Menu menu) {
        ...
        getMenuInflater().inflate(R.menu.menu_mother_health, menu);
        return true;
    }
