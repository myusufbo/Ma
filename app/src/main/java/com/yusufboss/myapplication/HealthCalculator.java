...
public class HealthCalculator extends ActionBarActivity {
    ...
    private void initDrawer(Bundle savedInstanceState) {
        ...
        final Toolbar toolbar = (Toolbar) findViewById(R.id.healthToolbar);
                        ...
                        if (drawerItem instanceof Nameable) {
                            ...
                            if (drawerItem.getIdentifier() == 0) {
                               ...
                               // startActivity(new Intent(getApplicationContext(),HealthCalculator.class));
                                ...
                                startActivity(new Intent(HealthCalculator.this, MotherHealth.class));
                            }
                            else if (drawerItem.getIdentifier() == 3) {

                                startActivity(new Intent(HealthCalculator.this, ChildHealth.class));
                            } else if (drawerItem.getIdentifier() == 4) {
                                startActivity(new Intent(HealthCalculator.this, Hospital.class));
                            } else if (drawerItem.getIdentifier() == 5) {
                                startActivity(new Intent(HealthCalculator.this, EmergencyContact.class));
                            }
